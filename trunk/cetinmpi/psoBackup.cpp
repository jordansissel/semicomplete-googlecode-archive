...
printf("summary file= %s\n",summary_filename);
	...
	//C1AgentDoc	TestAgent=masterAgent;
...
//printf("\n");
						...
						//if (CheckParticle(TestAgent, SendArray) == true)
						//{
					...
					/*	}
						...
						{
							printf("\n\n\nMaster did not send the invalid network.. Sending Dummy Network..\n\n\n");
							MPI_Send(&SendDArray,14999,MPI_INT,rank,iParticle,MPI_COMM_WORLD);
...
printf(" Master is Waiting to receive 2\n\n");
...
//printf("SENDING new work order for good acyclic particle\n\n");
					...
					//	MPI_Send(&SendArray,14999,MPI_INT,returningRank,iParticle,MPI_COMM_WORLD);
						...
						{
							printf("\n\n\nMaster did not send the invalid network.. Sending Dummy network..\n\n\n");
							MPI_Send(&SendDArray,14999,MPI_INT,returningRank,iParticle,MPI_COMM_WORLD);
