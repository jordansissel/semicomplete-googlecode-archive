...
bool C1AgentDoc::Valid_Network()
{
	...
	for (int i=0; i < l; i++)
	{
		...
		{
		   // printf(" Node has more than 5 parents");
			return false;
		}
	}
...
#define unsigned const int MaxNumOfCol=256,MaxColLength=16;
	...
	//node_names_filename="simpletest.txt";
...
////
	...
	//FILE* f=fopen("nodesizes.dat","rt");
	//FILE* g=fopen("nodenames.dat","rt");
